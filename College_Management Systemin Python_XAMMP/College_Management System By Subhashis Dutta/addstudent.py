...
def add():
    if name1.get()=="" or rol1.get()=="" or cs1.get()=="" or sgp1.get()=="" or fd1.get()=="" or courselist.get()=="" or department1.get()=="" :
...
title=Label(rt,text="Student Details",bd=5,relief=GROOVE,font=("constantia",30,"bold"),bg="yellow",fg="black")
