...
def Add():
    if fen.get()=="" or ln.get()=="" or cont.get()=="" or courselist.get()=="" or email1.get()==""or pass1.get()=="" or pass2.get()=="":
     ...
     mycursor=db.cursor()
     try:
        sql="insert into regadmi(fnm,lnm,contact,dob,course,gen,email,password,cpass)values(%s,%s,%s,%s,%s,%s,%s,%s,%s)"
...
course=Label(frame,text="",bg="white",font=("Times New Roman",15,"bold"))
course.place(x=30,y=240)
courselist=ttk.Combobox(frame,textvariable="vcourse",font=("Times New Roman",0,"bold"),state="readonly")
courselist["values"]=("SELECT","BTECH","BCA","MCA","MTECH")
courselist.place(x=0,y=0,width=0)
