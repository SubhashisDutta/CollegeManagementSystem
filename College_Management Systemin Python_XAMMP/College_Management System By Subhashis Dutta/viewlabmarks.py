...
title=Label(rt,text="View LAB Marks",bd=5,relief=GROOVE,font=("constantia",30,"bold"),bg="yellow",fg="black")
...
mk=Label(managefrm,text="Marks",font=("times new roman",15,"bold"),fg="black",bg="white")
...
studtab=ttk.Treeview(tabfrm,columns=("name","roll","uniroll","currentsem","course","department","subject","marks"),xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
...
studtab.heading("marks",text="Marks")
...
studtab.column("marks",width=100)
