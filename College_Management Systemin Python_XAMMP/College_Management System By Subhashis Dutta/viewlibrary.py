...
title=Label(rt,text="View Library Details",bd=5,relief=GROOVE,font=("constantia",30,"bold"),bg="yellow",fg="black")
...
studtab.heading("address",text="Department Id")
